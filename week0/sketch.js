...
function preload() {
  img1 = loadImage("img/left_eye.png");
  img2 = loadImage("img/right_eye.png");
  img3 = loadImage("img/circlish-2400px.png");
}
...
function draw() {
  ...
  if(positions.length>0){
    ...
    image(img1, positions[27][0], positions[27][1], 110, 90);
    image(img2, positions[32][0], positions[32][1], 110, 90);

    // 코(62번) 위에 눈에 해당하는 이미지를 올립니다.
    image(img3, positions[53][0], positions[53][1], 120, 120);
